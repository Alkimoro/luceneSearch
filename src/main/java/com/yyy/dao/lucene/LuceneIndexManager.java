...
public class LuceneIndexManager {
    ...
    public void createLuceneIndex() throws Exception {
        List<Sku> skuList = skuDao.findByQuery(new SkuQuery());
        ...
        Directory  dir = FSDirectory.open(Paths.get(LuceneSkuDao.indexPath.getAbsolutePath()));
